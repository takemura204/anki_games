...
import 'word_record_repository.dart';
...
class LocalWordRecordRepository implements WordRecordRepository {
  ...
  Future<WordRecord?> getById(int id) {
    final query = _db.select(_db.wordRecords)..where((t) => t.id.equals(id));
  ...
  @override
  Future<void> resetWeights() => _db.update(_db.wordRecords).write(
