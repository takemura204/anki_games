...
import 'package:app_it_pass/features/profile/router/profile_modal_router.dart';
...
class ProfilePage extends HookConsumerWidget {
            ...
            children: [
              ...
              if (!isLinked) ...[
                ...
                GlassContainer(
                  cardRadius: BorderRadius.circular(16),
                  padding: const EdgeInsets.all(AppSpacing.sm),
                  child: _AccountLinkRow(
                    onTap: () => router.showAuthLink(),
                  ),
                ),
              ],
              if (isLinked) ...[
                ...
                _DeleteAccountButton(
                  onTap: () => _deleteAccount(router, notifier),
                ),
              ],
  ...
  Future<void> _deleteAccount(
    ...
    await ProfileRepository().save(const UserProfile());
  }
}
            ...
            children: [
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      Haptics.of(HapticType.selection);
          ...
          child: IgnorePointer(
            child: AnimatedOpacity(
              ...
              child: ClipRRect(
                ...
                child: ColoredBox(
                  color: AppColors.itPassBgStart.withValues(alpha: 0.7),
                  child: Center(
                    child: Text(
                      'コピーしました',
